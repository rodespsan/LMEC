...
class AccesoryController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Accesory',array(
	...
	{
		$model=new Accesory('search');
		$model->unsetAttributes();  // clear any default values
		
		if(isset($_GET['Accesory']))
			$model->attributes=$_GET['Accesory'];
	 ...
	 * @param Accesory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='accesory-form')
		{
