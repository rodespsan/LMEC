...
class ActivityGuaranteeController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin', 'index', 'view', 'delete', 'activate', 'create', 'update'),
	...
	{
		$dataProvider=new CActiveDataProvider('ActivityGuarantee', array(
	...
	{
		$model=new ActivityGuarantee('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ActivityGuarantee']))
			$model->attributes=$_GET['ActivityGuarantee'];
	 ...
	 * @param ActivityGuarantee $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='activity-guarantee-form')
		{
