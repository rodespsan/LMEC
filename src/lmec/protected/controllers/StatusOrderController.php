...
class StatusOrderController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['StatusOrder'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('StatusOrder', array(
	...
	{
		$model=new StatusOrder('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StatusOrder']))
			$model->attributes=$_GET['StatusOrder'];
	 ...
	 * @param StatusOrder $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='status-order-form')
		{
