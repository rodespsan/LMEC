...
class SparePartsTypeController extends Controller
{
	/**
	...
	{
		$model=new SparePartsType;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SparePartsType']))
		{
	...
	{
		$model=new SparePartsType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SparePartsType']))
			$model->attributes=$_GET['SparePartsType'];
	 ...
	 * @param SparePartsType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='spare-parts-type-form')
		{
