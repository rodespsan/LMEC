...
class Accessory extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'tblAccessoryOrders' => array(self::HAS_MANY, 'TblAccessoryOrder', 'accessory_id'),
            'tblEquipmentTypeAccesories' => array(self::HAS_MANY, 'TblEquipmentTypeAccessory', 'accessory_id'),
        );
    }
